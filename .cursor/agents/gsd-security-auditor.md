...
**Verification depth scales with `asvs_level`** (see @/Users/gigi/Development/thinking-in-public/.cursor/gsd-core/references/security-asvs-levels.md for full definitions):
