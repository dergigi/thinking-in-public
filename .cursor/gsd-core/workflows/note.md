...
- **Global scope**: `/Users/gigi/Development/thinking-in-public/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/gigi/Development/thinking-in-public/.cursor/notes/`)
...
2. Glob `/Users/gigi/Development/thinking-in-public/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/gigi/Development/thinking-in-public/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/gigi/Development/thinking-in-public/.cursor/notes/` — works in any directory
