...
```
Agent(
  prompt="Read /Users/gigi/Development/thinking-in-public/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/gigi/Development/thinking-in-public/.cursor/gsd-core/templates/SECURITY.md`
