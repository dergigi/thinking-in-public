...
<required_reading>
@/Users/gigi/Development/thinking-in-public/.cursor/gsd-core/references/ai-frameworks.md
@/Users/gigi/Development/thinking-in-public/.cursor/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/gigi/Development/thinking-in-public/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/gigi/Development/thinking-in-public/.cursor/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/gigi/Development/thinking-in-public/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/gigi/Development/thinking-in-public/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/gigi/Development/thinking-in-public/.cursor/agents/gsd-eval-planner.md for instructions.
