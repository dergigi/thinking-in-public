...
<required_reading>
@/Users/gigi/Development/thinking-in-public/.cursor/gsd-core/references/user-story-template.md
@/Users/gigi/Development/thinking-in-public/.cursor/gsd-core/references/spidr-splitting.md
@/Users/gigi/Development/thinking-in-public/.cursor/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/gigi/Development/thinking-in-public/.cursor/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/gigi/Development/thinking-in-public/.cursor/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/gigi/Development/thinking-in-public/.cursor/gsd-core/references/spidr-splitting.md`. Briefly:
