...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/gigi/Development/thinking-in-public/.cursor/.gsd-surface.json`
(sibling to `/Users/gigi/Development/thinking-in-public/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/gigi/Development/thinking-in-public/.cursor/skills/gsd-*/`.
...
(`/Users/gigi/Development/thinking-in-public/.cursor`), NOT the skills sub-directory (`/Users/gigi/Development/thinking-in-public/.cursor/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/Users/gigi/Development/thinking-in-public/.cursor` as `configDir`. The skill dirs themselves live at
`/Users/gigi/Development/thinking-in-public/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Cursor — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/Users/gigi/Development/thinking-in-public/.cursor}"
SCOPE="global"
...
(i.e. `/Users/gigi/Development/thinking-in-public/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/gigi/Development/thinking-in-public/.cursor/.gsd-surface.json`
Install profile marker: `/Users/gigi/Development/thinking-in-public/.cursor/.gsd-profile`
Skill dirs: `/Users/gigi/Development/thinking-in-public/.cursor/skills/gsd-*/`
Engine module: `/Users/gigi/Development/thinking-in-public/.cursor/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/gigi/Development/thinking-in-public/.cursor/gsd-core/bin/lib/clusters.cjs`
</execution_context>
